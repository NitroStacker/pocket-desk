...
const styles = StyleSheet.create({
  ...
  smartGlyph: { color: colors.inverseText, fontSize: 22 },
  ...
  explainer: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: colors.surfaceRaised, borderRadius: radii.medium, padding: 13, marginTop: 10 },
  ...
  scanText: { color: colors.inverseText, fontSize: 12, fontWeight: '800' },
});
